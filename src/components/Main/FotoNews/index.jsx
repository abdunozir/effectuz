      ...
      >
        <SplideSlide className="fotonews__item">
          <Link className="fotonews__link" to="/">
            <img
              className="fotonews__img"
              src="https://picsum.photos/id/48/565/409"
              alt="asc"
            />
            <div className="fotonews__box">
              <h3 className="fotonews__subtitle">
                Samsung Galaxy F222 launched in India: Price, features, other
                details
              </h3>
            </div>
          </Link>
